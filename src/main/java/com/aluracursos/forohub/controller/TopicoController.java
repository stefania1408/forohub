...
import com.aluracursos.forohub.domain.curso.repository.RepositoryCurso;
import com.aluracursos.forohub.domain.respuesta.Respuesta;
import com.aluracursos.forohub.domain.respuesta.dto.DetalleRespuestaDTO;
import com.aluracursos.forohub.domain.respuesta.repository.RespuestaRepository;
...
import com.aluracursos.forohub.domain.topico.dto.DetallesTopicoDTO;
...
public class TopicoController {
    ...
    @PutMapping("/{id}")
    @Transactional
    @Operation(summary = "Actualizar el título, el mensaje, el estado o el ID del curso de un tema")
